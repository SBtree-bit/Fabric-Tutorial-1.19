package net.sbtree.tutorialmod.block;
...
import net.sbtree.tutorialmod.TutorialMod;
import net.sbtree.tutorialmod.block.custom.EggplantCropBlock;
import net.sbtree.tutorialmod.block.custom.JumpyBlock;
import net.sbtree.tutorialmod.block.custom.TanzaniteLampBlock;
...
public class ModBlocks {
    ...
    public static final Block JUMPY_BLOCK = registerBlock("jumpy_block",
            new JumpyBlock(FabricBlockSettings.of(Material.STONE).strength(4f).
                    requiresTool()), ModItemGroup.TANZANITE);
